<script lang="ts" setup>
    ...
    import { CREATE_CATEGORY_TITLE, EDIT_CATEGORY_TITLE } from '@modules/categories/constants'
    ...
    const getParent = () => {
        const id = unref(model).parentId
        return id ? unref(categories).find(it => it.id === id)! : null
    }
